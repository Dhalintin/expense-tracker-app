...
class ChatService {
    ...
    getConversationParticipants(conversationId) {
        return __awaiter(this, void 0, void 0, function* () {
            const participants = yield prisma.conversationParticipant.findMany({
                where: { conversationId },
                include: {
                    user: {
                        select: {
    ...
    getOtherParticipant(conversationId, currentUserId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const other = participants.find((u) => u.id !== currentUserId);
            if (!other)
                return null;
            return yield prisma.user.findUnique({ where: { id: other.id } });
        });
    }
    getUserConversationIds(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const participantRows = yield prisma.conversationParticipant.findMany({
                where: { userId },
